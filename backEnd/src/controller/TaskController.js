...
class TaskController {
    ...
    async done(req, res) {
      await TaskModel.findByIdAndUpdate(
        {'_id': req.params.id}, // o que eu quero buscar e de onde ele vai vir
        {'done' : req.params.done}, // o que eu quero buscar e de onde ele vai vir
        {new: true}) // o que eu busco é o true
        .then(response => {
          return res.status(200).json(response)
        })
        .catch(error => {
